...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await ExamplePluginFlutter.platformVersion;
  ...
  void _onKeyDown(int key) {
    print("key down:$key");
    ExamplePluginFlutter.onKeyDown(key).then((value) => print(value));
  }

  void _onKeyUp(int key) {
    print("key up:$key");
    ExamplePluginFlutter.onKeyUp(key).then((value) => print(value));
  }
